...
class ArticleAdminController extends BaseController
{
    ...
    public function new(EntityManagerInterface $em, Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()){
            ...
            $em->persist($article);
            $em->flush();
            $this->addFlash('success','the article created! knowledge is power.');
    ...
    public function edit(EntityManagerInterface $em ,Article $article, Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()){
            $em->persist($article);
            $em->flush();
            $this->addFlash('success','the article updated successfully!');
    ...
    /**
     * @Route("/admin/article/location-select", name="article_select_specific_location")
     * @IsGranted("ROLE_USER")
     */
